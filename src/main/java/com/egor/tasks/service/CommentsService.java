...
public interface CommentsService {
    ...
    void edit(Long id, ChangeCommentsTextDataDto changes, String email) throws UserNotFound, CommentNotFound, ForbiddenChanges;
    void delete(Long id, String email) throws CommentNotFound, UserNotFound, ForbiddenChanges;
